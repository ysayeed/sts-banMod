...
import banMod.powers.CommonPower;

import static banMod.DefaultMod.makeCardPath;
...
public class DefaultCommonPower extends AbstractDynamicCard {
    ...
    // Go check out DefaultAttackWithVariable and banMod.variable.DefaultCustomVariable
